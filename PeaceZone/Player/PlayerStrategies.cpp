    ...
    while (!done)
    {
        ...
        case 'a':
        {
            ...
            while (!validSourceAndTarget)
            {
                ...
                while (!nameValid) {
                    ...
                    if (nameValid && source->armyCount > 1) {
                        troops = getTroops(p, source->armyCount - 1);
                        if (troops != 0)
                    ...
                    {
                        std::cout << "Attacking territory has invalid troops. Try again." << std::endl;
                        //Go back to choosing source territory
                        nameValid = true;
                    }
                }
            }
        ...
        case 'd':
        {
            ...
            while (!nameValid)
            {
                ...
                {
                    std::cout << "Source territory has invalid troop number. Try again." << std::endl;
                }
                else
                {
                    troops = getTroops(p, source->armyCount - 1);
                    if (troops != 0 && source->armyCount != 1)
                        nameValid = true;
                }
            }
